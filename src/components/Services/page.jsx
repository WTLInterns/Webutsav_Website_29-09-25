...
const ServicesTimeline = ({ onInquiryOpen }) => {
  ...
  const featuresData = [
    { title: "Expert Team", desc: "Skilled professionals with years of industry experience", image: "/images/service1.jpeg" },
    {  title: "Fast Delivery", desc: "Quick turnaround times without compromising quality", image: "/images/service2.jpg" },
    {  title: "Custom Solutions", desc: "Tailored services to meet your specific business needs", image: "/images/service8.jpg" },
    { title: "Proven Results", desc: "Track record of successful projects and satisfied clients", image: "/images/service7.jpg" },
    {  title: "Quality Assurance", desc: "Rigorous testing and quality control processes", image: "/images/service5.jpg" },
    {  title: "24/7 Support", desc: "Round-the-clock assistance and maintenance services", image: "/images/service6.jpg" },
  ]
    ...
    <div>
      ...
      <section className="relative py-20 md:py-24 overflow-hidden bg-gradient-to-b from-sky-50 via-indigo-50/60 to-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <Link href="/Services/web-designing-development" passHref>
              <motion.button

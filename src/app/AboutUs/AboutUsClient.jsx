...
// //             activeTab === "digital" ? "bg-brand-primary-dark text-white" : "bg-gray-200 text-gray-700"
// //           } rounded-full`}
// //           onClick={() => {
...
// //         <button
// //           className={`px-4 py-2 ${
// //             activeTab === "it" ? "bg-brand-primary-dark text-white" : "bg-gray-200 text-gray-700"
// //           } rounded-full`}
// //           onClick={() => {
// //             setActiveTab("it")
// //           }}
...
//             <div className="bg-gradient-to-r from-sky-50 to-indigo-50 rounded-3xl overflow-hidden shadow-xl">
...
//                     </p>
//                     <button className="px-6 py-3 bg-gradient-to-r from-brand-primary-dark to-brand-secondary text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300">
//                       Explore More →
//                     </button>
//                   </div>
//                   <div className="mt-8">
...
//         className="relative bg-white rounded-xl shadow-md overflow-hidden flex flex-col h-full border border-sky-100/30 hover:border-indigo-200/50 transition-all duration-300 w-64 flex-shrink-0"
//       >
//         {/* Image section */}
//         <div className="relative h-28 w-full overflow-hidden">
//           {/* Country flag badge */}
//           <div className="absolute top-2 left-2 bg-white rounded-md px-2 py-1 shadow-sm z-10">
//             <span className="font-semibold text-brand-primary-dark text-xs">{cs.country}</span>
//           </div>
...
//           <h3 className="font-bold text-lg text-brand-primary-dark mb-1">{cs.title}</h3>
//           <p className="text-gray-600 text-xs leading-relaxed mb-2">{cs.desc}</p>
//           <div className="mt-auto">
//             {/* <button className="text-brand-primary-dark font-medium text-xs hover:text-blue-800 transition-colors flex items-center">
//               Read more
